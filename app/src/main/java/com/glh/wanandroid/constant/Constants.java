package com.glh.wanandroid.constant;
...
public class Constants {
    ...
    public static final String UPDATE_URL = "https://github.com/JsonChao/Awesome-WanAndroid/blob" +
            "/master/app/release/app-release.apk";
     ...
     * Path
     */
    //    public static final String PATH_DATA = WanAndroidApp.getInstance().getCacheDir()
